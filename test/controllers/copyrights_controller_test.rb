...
class CopyrightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create copyright" do
    assert_difference('Copyright.count') do
      post copyrights_url, params: { copyright: { applicant_name: @copyright.applicant_name, date: @copyright.date, ref_number: @copyright.ref_number, work: @copyright.work } }
    end
  ...
  test "should update copyright" do
    patch copyright_url(@copyright), params: { copyright: { applicant_name: @copyright.applicant_name, date: @copyright.date, ref_number: @copyright.ref_number, work: @copyright.work } }
